...
import '../../../Styles/Job/StatusJob.css'; // Import the custom CSS file
    ...
    return (
        <div className="status-job-container">
            <div className="status-job-card">
                ...
                <span className="status-heading">Application Status</span>
            ...
            <div className="job-details-card">
                <div className="job-details">
                    <span className="detail-heading">Job Description</span>
                    <p className="detail-text">{selectedJob.job.about}</p>

                    <div className="detail-item">
                        <span className="detail-heading">Job Type:</span>
                        <p className="detail-text">{selectedJob.job.jobtype}</p>
                    </div>

                    <div className="detail-item">
                        <span className="detail-heading">Job Mode:</span>
                        <p className="detail-text">{selectedJob.job.jobmode}</p>
                    </div>

                    <div className="detail-item">
                        <span className="detail-heading">Responsibilities</span>
                        <p className="detail-text">{selectedJob.job.responsibility}</p>
                    </div>
                </div>
            </div>
        </div>
