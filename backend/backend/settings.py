...
CORS_ALLOWED_ORIGINS = [
   "http://localhost:5173",
    ...
    'http://localhost:8000',  # Your Django API
]

CORS_ORIGIN_ALLOW_ALL = True  # Allow all origins (for development purposes)
# If you're using React as a separate frontend, you might need these CORS settings
...
CSRF_TRUSTED_ORIGINS = [
    "http://localhost:5174",  # Your frontend running on Vite/React
    "http://127.0.0.1:5174",
]
